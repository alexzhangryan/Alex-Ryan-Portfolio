    ...
    return(
        <>
            <div className="mb-30">
                ...
                <ProjectCard title="LoL Esports Predictor}" desc="A gradient boosted decision tree model built with Scikit Learn that predicts the outcome of a professional League of Legends game with 69% accuracy. Frontend built with Streamlit." img="LolPrediction.png" index={0} skills1="Python" skills2="Scikit Learn" skills3="Pandas" link="https://github.com/alexzhangryan/LOLEsportsRandomForest"/>
                ...
                <ProjectCard title="This Website!" desc="A portfolio website for myself, Alex Ryan, written in TypeScript. Utilizes the React framework as well as TailwindCSS." img="website.png" index={3} skills1="TypeScript" skills2="React" skills3="TailwindCSS" link="https://github.com/alexzhangryan/Alex-Ryan-Portfolio"/>
            </div>
